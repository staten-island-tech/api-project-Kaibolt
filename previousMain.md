Former code for the project.
This was stopped as you would have to code a dropdown for each section, even if there is no article in that section.
This is bad as it's too much to code, and the user might get no articles for a section they click on, making it an annoyance to find a section with articles.
